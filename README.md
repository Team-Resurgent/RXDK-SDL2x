...
- **SDL2 Mixer 2.8.1**: Fully functional and integrated into the port. (MP3, OGG, WAV, All tracker files supported by modplug)
...
- **SDL2 Net 2.2.0**:  Fully functional and integrated into the port.
